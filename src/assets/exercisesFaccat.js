export const exercisesFaccat = [
  { name: "Exercício 1 - Somar", func: exercise1 },
  { name: "Exercício 2 - Subtrair", func: exercise2 },
  { name: "Exercício 3 - Multiplicar", func: exercise3 },
  { name: "Exercício 4 - Dividir", func: exercise4 },
  { name: "Exercício 5 - Antecessor", func: exercise5 },
  { name: "Exercício 6 - Area de um Retângulo", func: exercise6 },
  { name: "Exercício 7 - Idade em Dias", func: exercise7 },
  { name: "Exercício 8 - Votos", func: exercise8 },
  { name: "Exercício 9 - Reajuste de Salário", func: exercise9 },
  { name: "Exercício 10 - Imposto sobre automóvel", func: exercise10 },
  { name: "Exercício 11 - Comissão de Venda de Carros", func: exercise11 },
  { name: "Exercício 12 - Celsius para Fahrenheit", func: exercise12 },
  { name: "Exercício 13 - Media de Notas (Ponderada sem IF)", func: exercise13 },
  { name: "Exercício 14 - Maior que 10?", func: exercise14 },
  { name: "Exercício 15 - Positivo ou Negativo", func: exercise15 },
  { name: "Exercício 16 - Calculo de Maças", func: exercise16 },
  { name: "Exercício 17 - Média de Nota (Com IF)", func: exercise17 },
  { name: "Exercício 18 - Pode Votar?", func: exercise18 },
  { name: "Exercício 19 - Maior (entre 2 valores)", func: exercise19 },
  { name: "Exercício 20 - Ordem Crescente", func: exercise20 },
  { name: "Exercício 21 - Horas Xadrez", func: exercise21 },
  { name: "Exercício 22 - Calcular Salario", func: exercise22 },
  { name: "Exercício 23 - Peso Ideal", func: exercise23 },
  { name: "Exercício 24 - Salario com Comissão", func: exercise24 },
  { name: "Exercício 25 - Verifica Saldo", func: exercise25 },
  { name: "Exercício 26 - Calculo de Estoque", func: exercise26 },
  { name: "Exercício 27 - Positivo, negativo ou Nulo", func: exercise27 },
  { name: "Exercício 28 - Maior entre 3 valores", func: exercise28 },
  { name: "Exercício 29 - Soma dos 2 maiores", func: exercise29 },
  { name: "Exercício 30 - Ordem Crescente", func: exercise30 },
  { name: "Exercício 31 - Forma Triangulo", func: exercise31 },
  { name: "Exercício 32 - Time Vencedor", func: exercise32 },
  { name: "Exercício 33 - Verificação de Números", func: exercise33 },
  { name: "Exercício 35 - Desconto de Combustível", func: exercise34 },
  { name: "Exercício 36 - Soma e Multiplicação de Idades", func: exercise35 },
  { name: "Exercício 37 - Maças e Morangos", func: exercise36 },
  { name: "Exercício 38 - Login", func: exercise37 },
  { name: "Exercício 40 - Desconto", func: exercise38 },
  { name: "Exercício 41 - Media de Aproveitamento", func: exercise39 },
  { name: "Exercício 42 - Aposentadoria", func: exercise40 },
  { name: "Exercício 44 - Diferente de 0 (Enquanto)", func: exercise41 },
  { name: "Exercício 45 - Diferente de 0 (Repita)", func: exercise42 },
  { name: "Exercício 46 - Diferente de 0 (Enquanto com Mensagem)", func: exercise43 },
  { name: "Exercício 47 - Diferente de 0 (Repita com Mensagem)", func: exercise44 },
  { name: "Exercício 48 - Media Simples (apenas valores válidos)", func: exercise45 },
  { name: "Exercício 49 - Novo Calculo de Média", func: exercise46 },
];

function exercise1() {
  // Exercício consiste em SOMAR dois valores digitados pelo usuário
  alert(`Você escolheu o ${exercisesFaccat[0].name}! Clique para continuar.`);
...
function exercise2() {
  alert(`Você escolheu o ${exercisesFaccat[1].name}! Clique para continuar.`);
...
function exercise3() {
  alert(`Você escolheu o ${exercisesFaccat[2].name}! Clique para continuar.`);
...
function exercise4() {
  alert(`Você escolheu o ${exercisesFaccat[3].name}! Clique para continuar.`);
...
function exercise5() {
  alert(`Você escolheu o ${exercisesFaccat[4].name}! Clique para continuar.`);
...
function exercise6() {
  alert(`Você escolheu o ${exercisesFaccat[5].name}! Clique para continuar.`);
...
function exercise7() {
  alert(`Você escolheu o ${exercisesFaccat[6].name}! Clique para continuar.`);
...
function exercise8() {
  alert(`Você escolheu o ${exercisesFaccat[7].name}! Clique para continuar.`);
...
function exercise9() {
  alert(`Você escolheu o ${exercisesFaccat[8].name}! Clique para continuar.`);
...
function exercise10() {
  alert(`Você escolheu o ${exercisesFaccat[9].name}! Clique para continuar.`);
...
function exercise11() {
  alert(`Você escolheu o ${exercisesFaccat[10].name}! Clique para continuar.`);
...
function exercise12() {
  alert(`Você escolheu o ${exercisesFaccat[11].name}! Clique para continuar.`);
...
function exercise13() {
  alert(`Você escolheu o ${exercisesFaccat[12].name}! Clique para continuar.`);
...
function exercise14() {
   ...
   */
  alert(`Você escolheu o ${exercisesFaccat[13].name}! Clique para continuar.`);
...
function exercise15() {
  ...
  alert(`Você escolheu o ${exercisesFaccat[14].name}! Clique para continuar.`);
...
function exercise16() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[15].name}! Clique para continuar.`);
...
function exercise17() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[16].name}! Clique para continuar.`);
...
function exercise18() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[17].name}! Clique para continuar.`);
...
function exercise19() {
  ...
  alert(`Você escolheu o ${exercisesFaccat[18].name}! Clique para continuar.`);
...
function exercise20() {
  ...
  alert(`Você escolheu o ${exercisesFaccat[19].name}! Clique para continuar.`);
...
function exercise21() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[20].name}! Clique para continuar.`);
...
function exercise22() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[21].name}! Clique para continuar.`);
...
function exercise23() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[22].name}! Clique para continuar.`);
...
function exercise24() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[23].name}! Clique para continuar.`);
...
function exercise25() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[24].name}! Clique para continuar.`);
...
function exercise26() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[25].name}! Clique para continuar.`);
...
function exercise27() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[26].name}! Clique para continuar.`);
...
function exercise28() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[27].name}! Clique para continuar.`);
...
function exercise29() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[28].name}! Clique para continuar.`);
...
function exercise30() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[29].name}! Clique para continuar.`);
...
function exercise31() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[30].name}! Clique para continuar.`);
...
function exercise32() {
  ...
  alert(`Você escolheu o ${exercisesFaccat[31].name}! Clique para continuar.`);
...
function exercise33() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[32].name}! Clique para continuar.`);
...
*/
  ...
  alert(`Você escolheu o ${exercisesFaccat[33].name}! Clique para continuar.`);
...
function exercise35() {
  ...
  */
  alert(`Você escolheu o ${exercisesFaccat[34].name}! Clique para continuar.`);
...
function exercise36() {
  ...
  */
  alert(`Você escolheu o ${exercisesFaccat[35].name}! Clique para continuar.`);
...
function exercise37() {
  ...
  */
  alert(`Você escolheu o ${exercisesFaccat[36].name}! Clique para continuar.`);
...
function exercise38() {
  ...
  */
  alert(`Você escolheu o ${exercisesFaccat[37].name}! Clique para continuar.`);
...
function exercise39() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[39].name}! Clique para continuar.`);
...
function exercise41() {
  ...
  */
  alert(`Você escolheu o ${exercisesFaccat[40].name}! Clique para continuar.`);
...
function exercise42() {
  ...
  alert(`Você escolheu o ${exercisesFaccat[41].name}! Clique para continuar.`);
...
function exercise43() {
  /*   
    ...
    informado seja ZERO.
  */
  alert(`Você escolheu o ${exercisesFaccat[42].name}! Clique para continuar.`);
...
function exercise44() {
  /*   
    ...
    informado seja ZERO.
  */
  alert(`Você escolheu o ${exercisesFaccat[43].name}! Clique para continuar.`);
...
function exercise45() {
  ...
  */
  ...
  alert(`Você escolheu o ${exercisesFaccat[44].name}! Clique para continuar.`);
...
function exercise46() {
  ...
  */
  alert(`Você escolheu o ${exercisesFaccat[45].name}! Clique para continuar.`);
